...
for TEAM in ${TEAMS}; do
	curl -s 'https://nemesis.dev-openclass.com/api/applications?refresh=false'  -H 'Authorization: Basic VVhVOTlGUjpGZWlsaW5nMTYwMkF1ZyE=' -H "user.team:$TEAM" > /tmp/apps-$TEAM.json
done
